...
**This is the heavy, methodical end of research.** It is not a fast overview — it is the workflow to reach for when getting the answer *wrong* costs more than the tokens spent getting it right.
...
Do **not** use it for quick fact-checks (just answer directly) or fast topic overviews where decision risk is low.
